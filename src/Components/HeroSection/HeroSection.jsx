...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="h-[100%] py-[290px] flex items-center bg-radial-gradient text-white"
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left  md:mb-0">
          ...
          <motion.div
            className="mt-8 flex justify-center md:justify-start space-x-4 font-Josefin font-bold"
